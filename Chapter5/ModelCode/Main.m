...
%%%%%%%% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
%%********************** READ INPUT FOLDER PATH AND OUTPUT FOLDER PATH for accessing all shape files IN hpc**************************** %%

inp_pathname = '/home/jc442626/RQ3/InputFiles/Case3';
op_pathname = '/home/jc442626/RQ3/OutputFiles/EF/Case3/Lambda_P75/';


for tf = 1 : 50 % for 50 input shape files, replace '50' with number of shape files
                % to run
    %%**************************************************************************
...
%     %$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    %%*****************CALL FOLLOWING CODE FOR A SINGLE FILE FROM LOCAL DRIVE *********************************************************
...
%     
 ...
 % array stores the EIGHT NEIGHBOURS for each target cell. Target cell is
    ...
    % THIS IS WHERE THE CHANGE WILL OCCUR  FOR THE LAMBDA VALUE - NEIGHBOURHOOD INFORMATION. Either change it manually or run
    % an array 

    lambda1 = 0.75;  %weight for contextual information
    ...
    %~%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% CASE 2 - Distance Meausre ( not used here. Can be used for in the future ) OR  CASE 1 - Random Hawk and Dove for RQ2/chapter 4.
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
